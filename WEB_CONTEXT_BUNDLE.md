...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-46738"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-v1",
      "problem_contract_sha256": "a88db1e594e9786208c878db89892fb961163506bc9e5a7a32584e3e34322b52",
      "problem_id": "problem:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a",
      "route_id": "route:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-source-fidelity-01",
      "graph_id": "graph:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "An $H$-factor in a graph $G$ is a set of vertex-disjoint copies of $H$ covering all vertices of $G$. Problem Let $c$ be a fixed positive real number and $H$ a fixed graph. Is it NP-hard to determine whether a graph $G$ on $n$ vertices and minimum degree $cn$ contains and $H$-factor?"
          },
          "statement_sha256": "39c9b4b11d39d11a16329f83dceee762361d956f80988f487ff9504aeaf01ee3"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-root",
      "route_id": "route:um-opg-46738-complexity-of-the-h-factor-problem-883d7c9a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-46738-56cc29419029",
        "url": "https://www.unsolvedmath.com/problems/OPG-46738"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
